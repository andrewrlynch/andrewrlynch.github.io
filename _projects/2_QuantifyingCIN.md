...
<div class="img-frame img-frame-multi">
    <img src="{{site.baseurl}}/images/image42.gif" class = "adjacent" style="width:24%">
    <img src="{{site.baseurl}}/images/image43.gif" class = "adjacent" style="width:24%">
    <img src="{{site.baseurl}}/images/image45.gif" class = "adjacent" style="width:24%">
    <img src="{{site.baseurl}}/images/image49.gif" class = "adjacent" style="width:24%">
</div>
